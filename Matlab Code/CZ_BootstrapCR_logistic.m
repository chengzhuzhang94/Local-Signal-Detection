...
% boots_lam_vec: a list of candidate lambda values (SCAD penalty hyperparameter) used for Bootstrap samples, we turn to use the best lambda out of this candidate list
