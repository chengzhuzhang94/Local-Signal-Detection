...
stepAIC_DM_std = readtable('new BJ stepAIC design matrix std.csv'); %stepAIC_col_names = stepAIC_DM.Properties.VariableNames; stepAIC_col_names(1)={'x_Intercept'};
